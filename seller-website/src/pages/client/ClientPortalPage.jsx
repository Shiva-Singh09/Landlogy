...
export function ClientPortalPage() {
  ...
  const renderPage = () => {
    switch (route) {
      case 'properties':
        return <PropertiesPage properties={properties} loading={loading} error={error} onViewProperty={(id) => { window.location.href = `/client-portal/properties/${encodeURIComponent(id)}`; }} />;
